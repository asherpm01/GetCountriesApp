...
{
    public static class GetBorderingCountry
    {
        [FunctionName("GetBorderingCountry")]
        public static async System.Threading.Tasks.Task<IActionResult> RunAsync([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequest req, TraceWriter log)
        {
            ...
            var response = await client.GetAsync(Environment.GetEnvironmentVariable("COUNTRIES_API_URL_GetBotheringCountry")+code);
